...
RSpec.describe "Api::V1::SaleReports", type: :request do
  ...
  #     create :sale_report, school: sch, quantity: 4, item: item, created_at: Date.new(2020, 10, 4)
  #     create :sale_report, school: sch, quantity: 36, item: item, created_at: Date.new(2021, 10, 8)


  #     create :sale_report, school: sch, quantity: 10, item: item, created_at: Time.now

      
  #     create :sale_report, school: sch, quantity: 7, item: item, created_at: term_date.start_date

  #     create :sale_report, school: sch, quantity: 31, item: item, created_at: Time.now
      
      
  #     create :sale_report, school: sch, quantity: 15, item: item, created_at: term_date.end_date
  ...
  #       subject {  get @sale_report_url, headers: @headers, params: {date_range: {from: Date.new(2020, 10, 4), to: Time.now}} } 
