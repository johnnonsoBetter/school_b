...
RSpec.describe "Api::V1::GuidanceStudentAttendances", type: :request do
  before do 
    ...
    @guidance_student_attendances_url = '/api/v1/guidance_student_attendances'
  ...
  context "when guidance is not authenticated" do
    it "return http status unauthorized" do
      ...
      get @guidance_student_attendances_url
  ...
  context "when guidance is authenticated " do
    ...
    context "when term id params does not exists" do
      ...
      before do 
        ...
        get @guidance_student_attendances_url, headers: @headers, params: {student_id: 34}
    ...
    context "when term id params exists" do
      ...
      before do 
        ...
        get @guidance_student_attendances_url, headers: @headers, params: {student_id: 34, term_id: 1}
        @json_body = JSON.parse(response.body)
