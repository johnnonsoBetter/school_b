...
RSpec.describe "Api::V1::RestockReports", type: :request do
  describe "POST /create" do
    ...
    before do 
      ...
      @restock_report_params = {restock_report: {quantity: 3, item_id: 1 }}

      @login_url = '/api/v1/auth/sign_in'
      @restock_report_url = '/api/v1/restock_reports'
    ...
    context "when admin is authenticated " do
      ...
      subject {  post @restock_report_url, headers: @headers, params: @restock_report_params } 

      context "when new restock_report report has been created" do
        it "increment restock_report report by 1" do
          expect{subject}.to change{RestockReport.count}.by(1)
        end
        ...
        it "increment restock_report quantity by 3" do 
          expect{subject}.to change{Item.find(1).quantity}.by(3)
        end
      ...
      context "when new restock_report failed to be created" do
          ...
          it "returns htpp status code unprocessable entity" do
            post @restock_report_url, headers: @headers, params: {restock_report: {quantity: nil, restock_report_id: 1}}
  ...
  describe "GET /index" do
    ...
    context "when admin is authenticated " do
      ...
      subject {  get @restock_report_url, headers: @headers } 

      context "when term_id params exists" do
        subject {  get @restock_report_url, headers: @headers, params: {term_id: 1} } 
      ...
      context "when date params exists" do
        subject {  get @restock_report_url, headers: @headers, params: {date: Time.now} } 
