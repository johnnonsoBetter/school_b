...
RSpec.describe DebtRecoveredReport, type: :routing do
    ...
    describe "GET" do
        it "routes api/v1/debt_recovered_reports to api/v1/debt_recovered_reports#index" do
           expect(get 'api/v1/debt_recovered_reports').to    route_to( :controller => 'api/v1/debt_recovered_reports', :action => 'index')  
