...
ActiveRecord::Schema.define(version: 2021_11_06_184526) do
  ...
  create_table "web_push_notifications", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "guidance_id", null: false
    t.index ["guidance_id"], name: "index_web_push_notifications_on_guidance_id"
  end
  ...
  add_foreign_key "web_push_notifications", "guidances"
end
